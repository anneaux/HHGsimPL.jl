...
struct BeamOTCcomplex <: Beam
	...
	function BeamOTCcomplex(;Intensity1::Real, Intensity2::Real,
		# omega
		lambda::Real, 
		r::Int64, s::Int64,
	...
	function BeamOTCcomplex(E01::Number,
	E02::Number,
	omega1::Number,
	omega2::Number,
	epsilon1::Number,
...
function BeamBEOTC(;Intensity1::Real, Intensity2::Real,
	...
	BeamOTCcomplex(Intensity1=Intensity1,Intensity2=Intensity2,
		lambda=lambda,
		r=r,s=s,
...
# fundamental_frequency(b::BeamOTCcomplex) = b.omega1

#### field equations ###########
function electric_field(b::BeamOTCcomplex)
...
E(b::BeamOTCcomplex) = electric_field(b)


function vector_potential(b::BeamOTCcomplex)
	phi = b.phi
	epsilon1 = b.epsilon1
	E01 = b.E01
	omega1 = b.omega1
...
A(b::BeamOTCcomplex) = vector_potential(b)



function integrated_vector_potential(b::BeamOTCcomplex)
...
IA(b::BeamOTCcomplex) = integrated_vector_potential(b)



function electric_field_amplitude_derivative(b::BeamOTCcomplex)
	## Beam Characterization from milo2020biell
	phi = b.phi
	epsilon1 = b.epsilon1
	E01 = b.E01
...
function get_Up(b::BeamOTCcomplex)
	ω1 = b.omega1
	ω2 = b.omega2
